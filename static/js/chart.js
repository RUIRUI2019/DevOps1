        ...
        series: [
            {
                ...
                data: (function () {
                    var res = [];
                    len = result.length;
                    f = result[len-2].equipment_id
                    m=result[len-2].rate
                     console.log(f)
                    console.log(m)
                    res.push({value: f, name: '伺服报警率'});
                    res.push({value: m, name: '正常率'});
        ...
        series: [
            {
                ...
                data: (function () {
                    var res = [];
                    len = result.length;
                    f = result[len-1].equipment_id
                    m=result[len-1].rate
                     console.log(f)
                    console.log(m)
                    res.push({value: f, name: '急停报警率'});
                    res.push({value: m, name: '正常率'});
